      ...
      <main className="container mx-auto px-4 py-12">
        <article className="max-w-4xl mx-auto">
          ...
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-6">Under $25</h2>
          ...
          {/* Under $50 Section */}
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-6">Under $50</h2>
          ...
          {/* Under $100 Section */}
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-6">Under $100</h2>
          ...
          {/* Under $200 Section */}
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-6">Under $200</h2>
          ...
          {/* Premium Gifts $300+ Section */}
          <section className="mb-12">
            <h2 className="text-3xl font-bold mb-6">Premium Gifts $300+</h2>
